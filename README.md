# [DEPRECATED] Twilio Source dbt Package

> _This package has been archived and is no longer maintained. Use [`dbt_twilio`](https://github.com/fivetran/dbt_twilio) instead, which now contains all models previously found here._
